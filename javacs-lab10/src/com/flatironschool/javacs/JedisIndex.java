...
public class JedisIndex {
	...
	public void indexPage(String url, Elements paragraphs) {
		...
		String label = termCounter.getLabel();
		String hashname = termCounterKey(label);
		//t.del(hashname);
		for (String term: termCounter.keySet()) {
			Integer count = termCounter.get(term);
			transaction.hset(hashname, term, count.toString());
			transaction.sadd(urlSetKey(term), label);
		}
